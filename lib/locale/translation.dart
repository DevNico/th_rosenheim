...
class ThTranslations {
  ...
  // Settings
  String get settingsTimetableNotConfigured => text('settings_timetable_not_configured');
  String get settingsSemesterNotConfigured => text('settings_semester_not_configured');
  String get settingsSemesterNotConfiguredButton => text('settings_semester_not_configured_button');
  String get settingsCourseNotConfigured => text('settings_course_not_configured');
  String get settingsCourseNotConfiguredButton => text('settings_course_not_configured_button');
  String get settingsLecturesNotConfigured => text('settings_lectures_not_configured');
  String get settingsLecturesNotConfiguredButton => text('settings_lectures_not_configured_button');
  ...
  String get settingsDarkThemeDescription => text('settings_dark_theme_description');
  String get settingsLanguageTitle => text('settings_language_title');
  String get settingsLanguageDescription => text('settings_language_description');
  ...
  String get settingsSemesterDescription => text('settings_semester_description');
  ...
  String get settingsLecturesDescription => text('settings_lectures_description');
